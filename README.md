...
There is also a **Sass utility allowing to highlight the site structure** (pretty useful in development). Simply uncomment [its import in `style.sass`](sass/style.sass#L29) if you want to use it.
